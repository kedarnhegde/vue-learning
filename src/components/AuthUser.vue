    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card shadow-lg">
                <div class="card-body ">
                    <div v-if="isLoggedIn">
                        <p class="h3 fw-bolder text-success">
                            Welcome User
                        </p>
                        <p class="fw-bold">
                    ...
                    <div>
                        <button v-if="!isLoggedIn" class="btn btn-success m-1" @click="login">Login</button>
                        <button v-else class="btn btn-danger m-1" @click="logout">Logout</button>
                    </div>
                </div>
            </div>
        </div>
